...
param metadata resourceInput<'Microsoft.Network/dnsZones/SOA@2018-05-01'>.properties.metadata?

@description('Optional. A SOA record.')
param soaRecord resourceInput<'Microsoft.Network/dnsZones/SOA@2018-05-01'>.properties.SOARecord?
...
resource SOA 'Microsoft.Network/dnsZones/SOA@2018-05-01' = {
  name: name
  parent: dnsZone
  properties: {
    metadata: metadata
