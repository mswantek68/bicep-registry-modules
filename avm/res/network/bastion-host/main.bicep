...
module publicIPAddress '../../../res/network/public-ip-address/main.bicep' = if (empty(bastionSubnetPublicIpResourceId) && (skuName != 'Developer') && (!enablePrivateOnlyBastion)) {
...
import { dnsSettingsType, ipTagType, ddosSettingsType } from '../../../res/network/public-ip-address/main.bicep'
