metadata name = 'Public DNS Zone NS record'
metadata description = 'This module deploys a Public DNS Zone NS record.'
...
resource NS_roleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [
  for (roleAssignment, index) in (formattedRoleAssignments ?? []): {
    name: roleAssignment.?name ?? guid(NS.id, roleAssignment.principalId, roleAssignment.roleDefinitionId)
    properties: {
